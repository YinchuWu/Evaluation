...
if __name__ == "__main__":
    ...
    if SingleExp:
        ...
        checkpoints = [8000,10000,12000,14000,16000,18000,20000]#,24000,26000,28000,30000]
    ...
    test_infos = ['missfresh-yolo-voc-800-0523']
    # names of axis legend
    legend_names = ['missfresh-yolo-voc-800-0523']

    # checkpoints of models
    checkpoints = [8000,10000,12000,14000,16000,18000,20000]#,24000,26000,28000,30000]4000,6000,6000,8000,
